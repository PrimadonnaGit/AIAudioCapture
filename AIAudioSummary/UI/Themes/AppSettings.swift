...
class AppSettings: ObservableObject {
    ...
    init() {
        // 저장된 설정 로드 또는 기본값 사용
        uiOpacity = UserDefaults.standard.object(forKey: "uiOpacity") as? Double ?? 0.85
        backgroundOpacity = UserDefaults.standard.object(forKey: "backgroundOpacity") as? Double ?? 0.95
